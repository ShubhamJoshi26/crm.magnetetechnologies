...
$id = Session()->get('id');
$permission = UserController::getUserPermissionByName('payroll',$id);
                                    ...
                                    foreach($employees['data'] as $employee)
                                    {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/salary-configuration/editconfig/{{$employee['id']}}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
