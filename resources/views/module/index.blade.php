...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
        <div class="btn-group">
          <a type="button" href='module/create' class="btn btn-primary">Add New</a>
                                    ...
                                    foreach($data as $modules)
                                    {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="module/create?id={{$modules['moduleid']}}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                    <a href="javascript:void(0)" onclick="deleteModule({{$modules['moduleid']}});"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                    }
