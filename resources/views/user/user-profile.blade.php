								...
								<div class="card-body">
									...
									<ul class="list-group list-group-flush">
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											...
											<span class="text-secondary">https://magnetetechnologies.com/</span>
										</li>
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											...
											<span class="text-secondary"><input type="text" id="github" name="github" value="<?php echo $users['data'][0]['github']; ?>" class="form-control"></span>
										</li>
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											...
											<span class="text-secondary"><input type="text" class="form-control" name="twitter" id="twitter" value="<?php echo $users['data'][0]['twitter']; ?>"></span>
										</li>
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											...
											<span class="text-secondary"><input type="text" class="form-control" name="instagram" id="instagram" value="<?php echo $users['data'][0]['instagram']; ?>"></span>
										</li>
										<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
											...
											<span class="text-secondary"><input type="text" class="form-control" id="facebook" name="facebook" value="<?php echo $users['data'][0]['facebook']; ?>"></span>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="row mb-3">
										...
										<div class="col-sm-9 text-secondary">
											<input readonly name="userid" type="lable" class="form-control" value="<?php echo $users['data'][0]['id']; ?>" />
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
										...
										<div class="col-sm-9 text-secondary">
											<input type="text" required name="name" class="form-control" value="<?php echo $users['data'][0]['name']; ?>" />
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
										...
										<div class="col-sm-9 text-secondary">
											<input type="email" required name="email" class="form-control" value="<?php echo $users['data'][0]['email']; ?>" />
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9 text-secondary">
											<input type="text" class="form-control" name="mobile" value="<?php echo $users['data'][0]['mobile']; ?>" />
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
