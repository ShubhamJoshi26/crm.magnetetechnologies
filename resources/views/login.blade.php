...
<!-- Mirrored from codervent.com/rocker/demo/vertical/auth-basic-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2023 05:24:41 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
						...
						<div class="card mb-0">
							...
							@include('layout.alert')
								<div class="p-4">
									...
									<div class="form-body">
										<form class="row g-3" action="UserLogin" method="post" enctype="multipart/form-data">
                                            @csrf
											<div class="col-12">
...
<!-- Mirrored from codervent.com/rocker/demo/vertical/auth-basic-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2023 05:24:42 GMT -->
</html>